...
export const createWatchlistItemSchema = z.object({
  ...
  // User Personal Data
  added_date: z.string().datetime('Invalid added date format'),
  ...
  watch_date: z.string().datetime('Invalid watch date format').nullable().default(null),
});
...
export const updateWatchlistItemSchema = z.object({
  ...
  watch_date: z.string().datetime('Invalid watch date format').nullable().optional(),
}).strict();
